    ...
    <>
      <section id="about" className="w-full flex flex-col items-center justify-around py-20 px-6 gap-5 text-white z-10">
        <div className="w-full text-center sm:text-left sm:pl-20 mt-20">
          <h3 className="mb-5 lg:text-5xl sm:text-sm font-custom">
            EXPERIENCE :
          </h3>
          <p className="lg:text-xl sm:text-sm lg:w-11/12">
        ...
        <div className="w-full text-center lg:text-left sm:pl-20 mt-5 " >
          <h3 className="mb-5 lg:text-5xl sm:text-2xl font-light font-custom ">
            AREAS OF EXPERTISE :
          </h3>
          <div className='lg:text-2xl sm:text-sm '>
          <h5 className=" text-purple-500 mb-5">
