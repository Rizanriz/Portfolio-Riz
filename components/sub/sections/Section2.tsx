  ...
  return (
    <>
      <section id="about" className="w-full flex flex-col items-center justify-around py-20 px-6 gap-5 text-white z-10">
        <div className="w-full text-left sm:pl-20 sm:mt-20">
          <h3 className="mb-5 text-4xl font-custom">EXPERIENCE :</h3>
          <h2 className='mb-5 lg:text-3xl sm:text-sm font-custom'>Luminar Technolab <br />
            <span className='mb-5 lg:text-2xl sm:text-sm font-custom'>MERN Stack Developer Intern : January 2024 – July 2024</span>
          </h2>

          <p className="text-sm lg:text-xl lg:w-11/12 ">
          ...
          <h2 className='mb-5 lg:text-3xl sm:text-sm font-custom'>Druv360° <br />
            <span className='mb-5 lg:text-2xl sm:text-sm font-custom'>Junior MERN Stack Developer : September 2024 – January 2025</span>
          </h2>

          <p className="text-sm lg:text-xl md:text-sm lg:w-11/12">
